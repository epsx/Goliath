...
// assets/bios folders, Goliath profile/playtime/library/audio-export state,
// and the jollygood/geolith config file paths).
#pragma once
...
struct AppPaths {
    ...
    // Goliath-owned favorites and future personal-library fields. Like exact-
    // media profiles and playtime, this file is never generated by a rescan.
    std::filesystem::path game_library_state_json;  // <config>/game_library_state.json
